...
public class TokenContract implements Contract {
    ...
    public void verify(LedgerTransaction tx) throws IllegalArgumentException {
        ...
        if (!(commands.get(0).getValue() instanceof TokenContract.Commands.Issue))
        ...
        if (!(tokenState.getAmount() > 0)) throw new IllegalArgumentException("Token amount must be greater than zero");
